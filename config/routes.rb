Rails.application.routes.draw do
  # Routes for the Movieso resource:
  # CREATE
  get "/moviesos/new", :controller => "moviesos", :action => "new"
  post "/create_movieso", :controller => "moviesos", :action => "create"

  # READ
  get "/moviesos", :controller => "moviesos", :action => "index"
  get "/moviesos/:id", :controller => "moviesos", :action => "show"

  # UPDATE
  get "/moviesos/:id/edit", :controller => "moviesos", :action => "edit"
  post "/update_movieso/:id", :controller => "moviesos", :action => "update"

  # DELETE
  get "/delete_movieso/:id", :controller => "moviesos", :action => "destroy"
  #------------------------------
